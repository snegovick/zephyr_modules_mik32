...
#define USART1_RTS_PB11 \
	MIK32_PINMUX_AF('B', 11, AF1)

/* USART1_CTS */
#define USART1_CTS_PB10 \
	MIK32_PINMUX_AF('B', 10, AF1)
...
#define SPI1_NSS3_PB7 \
	MIK32_PINMUX_AF('B', 7, AF1)

/* SPI1_NSS2 */
#define SPI1_NSS2_PB6 \
	MIK32_PINMUX_AF('B', 6, AF1)

/* SPI1_NSS1 */
#define SPI1_NSS1_PB5 \
	MIK32_PINMUX_AF('B', 5, AF1)

/* SPI1_NSS0 */
#define SPI1_NSS0_PB4 \
	MIK32_PINMUX_AF('B', 4, AF1)

/* SPI1_NSSIN */
#define SPI1_NSSIN_PB3 \
	MIK32_PINMUX_AF('B', 3, AF1)

/* SPI1_CLK */
#define SPI1_CLK_PB2 \
	MIK32_PINMUX_AF('B', 2, AF1)

/* SPI1_MOSI */
#define SPI1_MOSI_PB1 \
	MIK32_PINMUX_AF('B', 1, AF1)

/* SPI1_MISO */
#define SPI1_MISO_PB0 \
	MIK32_PINMUX_AF('B', 0, AF1)

/* SPI0_NSS3 */
#define SPI0_NSS3_PC6 \
	MIK32_PINMUX_AF('C', 6, AF1)
...
/* SPIFI_CS */
#define SPIFI_CS_PC1 \
	MIK32_PINMUX_AF('C', 1, AF1)

/* SPIFI_SCLK */
#define SPIFI_SCLK_PC0 \
	MIK32_PINMUX_AF('C', 0, AF1)

/* I2C0_SCL */
#define I2C0_SCL_PA10 \
	MIK32_PINMUX_AF('A', 10, AF1)
...
#define USART0_RTS_PA8 \
	MIK32_PINMUX_AF('A', 8, AF1)

/* USART0_CTS */
#define USART0_CTS_PA7 \
	MIK32_PINMUX_AF('A', 7, AF1)

/* USART0_TX */
#define USART0_TX_PA6 \
	MIK32_PINMUX_AF('A', 6, AF1)

/* USART0_RX */
#define USART0_RX_PA5 \
	MIK32_PINMUX_AF('A', 5, AF1)

/* SPI0_NSS0 */
#define SPI0_NSS0_PA4 \
	MIK32_PINMUX_AF('A', 4, AF1)

/* SPI0_NSSIN */
#define SPI0_NSSIN_PA3 \
	MIK32_PINMUX_AF('A', 3, AF1)

/* SPI0_CLK */
#define SPI0_CLK_PA2 \
	MIK32_PINMUX_AF('A', 2, AF1)

/* SPI0_MOSI */
#define SPI0_MOSI_PA1 \
	MIK32_PINMUX_AF('A', 1, AF1)

/* SPI0_MISO */
#define SPI0_MISO_PA0 \
	MIK32_PINMUX_AF('A', 0, AF1)

/* SPI0_NSS2 */
#define SPI0_NSS2_PB15 \
	MIK32_PINMUX_AF('B', 15, AF1)

/* SPI0_NSS1 */
#define SPI0_NSS1_PB14 \
	MIK32_PINMUX_AF('B', 14, AF1)

/* I2C1_SCL */
#define I2C1_SCL_PB13 \
	MIK32_PINMUX_AF('B', 13, AF1)
